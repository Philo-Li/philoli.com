...
Tooladres: [philoli.com/projects/ebook-translator](https://philoli.com/projects/ebook-translator)

<!--more-->

Sinds de lancering is de tool alom geprezen. Dit zijn de belangrijkste functies:

-   Vertaal elk boek, waarbij de vertaling en het origineel afwisselend worden weergegeven, en ondersteuning voor onderlinge vertalingen tussen meer dan 40 talen.
-   Drie zorgvuldig ontwikkelde vertaalstijlen: algemeen-natuurlijk (dicht bij het origineel), roman en vakliteratuur, met uitstekende vertaalresultaten.
-   Biedt ook ondersteuning voor wiskundige formules in boeken.
-   Ondersteuning voor EPUB en PDF.
-   Ook gescande PDF's worden ondersteund. Dankzij de multimodale functies van krachtige AI-modellen worden formules nauwkeurig herkend, wat ook bij oudere boeken uitstekend werkt.
-   Voor vakliteratuur kunnen gebruikers hun eigen terminologielijsten uploaden, wat resulteert in nog nauwkeurigere vertalingen voor specialistische boeken.
-   De vertaalvoortgang wordt automatisch lokaal in de browser opgeslagen. Sluit de pagina en open deze opnieuw om verder te gaan waar je gebleven was. Vertaalde boeken worden bewaard in je geschiedenis, zodat je ze op elk moment opnieuw kunt openen, bewerken of exporteren. (Ondersteuning voor de vertaalgeschiedenis van de laatste 10 boeken.)
-   Je bestanden worden niet naar servers geüpload; alle bestandsanalyse en vertaalverzoeken vinden plaats binnen je eigen browser.
-   Volgens de designfilosofie 'laat de software het complexe doen, houd het voor de gebruiker simpel', is de interface strak en elegant, het gebruiksgemak intuïtief en de functionaliteit krachtig genoeg. Het heeft dan ook al veel lof geoogst.
...
<figure class="post-cover">
  <img src="/uploads/images/ebook-translator/ebook-translator-02.webp" alt="Vertaalvoorbeeld 1" />
</figure>

<figure class="post-cover">
  <img src="/uploads/images/ebook-translator/ebook-translator-04.webp" alt="Vertaalvoorbeeld 2" />
</figure>
...
<figure class="post-cover">
  <img src="/uploads/images/ebook-translator/ebook-translator-01.webp" alt="Contactgegevens" />
</figure>

---

> Probeer het zelf: [philoli.com/projects/ebook-translator](https://philoli.com/projects/ebook-translator)

## Meer lezen

- [12 goede boeken: mijn favorieten van 2025](/zh/blog/2025-top-rated-reading-list)
