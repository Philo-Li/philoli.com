---
layout: blog
title: Predstavljam preprost in učinkovit prevajalnik dvojezičnih e-knjig
...
Orodje je na voljo na: [philoli.com/projects/ebook-translator](https://philoli.com/projects/ebook-translator)

<!--more-->

Orodje je bilo takoj po predstavitvi izjemno dobro sprejeto. Njegove ključne funkcije vključujejo:

- Prevajanje katerekoli knjige, pri čemer se prevod in izvirnik prikazujeta vzporedno. Podprto je prevajanje med več kot 40 jeziki.
- Skrbno so bili razviti trije priljubljeni slogi prevajanja: splošni naravni (blizu izvirniku), leposlovni in strokovni. Rezultati prevajanja so izjemni.
- Podpora tudi za matematične formule v knjigah.
- Podpora za formata EPUB in PDF.
- Podprti so tudi skenirani PDF-ji. Z uporabo zmogljivih večmodalnih zmožnosti modelov umetne inteligence so formule natančno prepoznane, kar se odlično obnese tudi pri starejših knjigah.
- Za strokovne knjige lahko uporabniki naložijo svoje glosarje terminologije, kar omogoča še natančnejše prevajanje v specifičnih strokovnih področjih.
- Napredek prevajanja se samodejno shranjuje lokalno v brskalniku. Če zaprete in ponovno odprete stran, lahko nadaljujete tam, kjer ste končali. Prevedene knjige se shranijo v zgodovino, od koder jih lahko kadarkoli ponovno odprete, uredite ali izvozite. (Podprta je zgodovina prevajanja zadnjih 10 knjig.)
- Vaše datoteke se ne nalagajo na noben strežnik; analiza datotek in prevajalske zahteve se izvedejo v vašem brskalniku.
- V skladu z oblikovalsko filozofijo "kompleksnost prepusti programski opremi, preprostost uporabniku" je vmesnik čist in eleganten, uporaba enostavna, funkcionalnosti pa so dovolj zmogljive, kar je že prineslo številne pozitivne odzive.
...
1.  Odprite [Ebook Translator](https://philoli.com/projects/ebook-translator).
...
<figure class="post-cover">
  <img src="/uploads/images/ebook-translator/ebook-translator-03.webp" alt="Vmesnik Ebook Translatorja" />
</figure>

## Prikaz nekaterih prevodov

<figure class="post-cover">
  <img src="/uploads/images/ebook-translator/ebook-translator-02.webp" alt="Primer prevoda 1" />
</figure>

<figure class="post-cover">
  <img src="/uploads/images/ebook-translator/ebook-translator-04.webp" alt="Primer prevoda 2" />
</figure>
...
<figure class="post-cover">
  <img src="/uploads/images/ebook-translator/ebook-translator-01.webp" alt="Kontakt" />
</figure>

---

> Preizkusite ga: [philoli.com/projects/ebook-translator](https://philoli.com/projects/ebook-translator)

## Več za branje

- [12 odličnih knjig: seznam visoko ocenjenih knjig, prebranih v letu 2025](/zh/blog/2025-top-rated-reading-list)
