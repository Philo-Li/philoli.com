...
(توضیح تکمیلی: برخی از خوانندگان اشاره کردند که عبارت فوق چندان دقیق نبود، بنابراین توضیحات بیشتری ارائه می‌شود. اعداد صحیح تحت عمل جمع، یک گروه آبلی تشکیل می‌دهند. اعداد طبیعی N تحت عمل جمع یک گروه آبلی نیستند؛ برای مثال، عدد 3 دارای معکوس -3 نیست، زیرا -3 یک عدد طبیعی محسوب نمی‌شود. اعداد حقیقی غیرصفر، اعداد گویا غیرصفر و اعداد مختلط غیرصفر تحت عمل ضرب، یک گروه آبلی تشکیل می‌دهند. تشبیه اصلی در متن، عمدتاً برای این بود که مبتدیان شهود اصلی "جابجایی‌پذیر در برابر ناجابجایی‌پذیر" را درک کنند.)
