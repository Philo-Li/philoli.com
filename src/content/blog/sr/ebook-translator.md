...
Alat možete pronaći ovde: [philoli.com/projects/ebook-translator](https://philoli.com/projects/ebook-translator)

<!--more-->

Odmah po objavljivanju, alat je naišao na izuzetno pozitivan prijem. Njegove ključne funkcije uključuju:

- Prevođenje bilo koje knjige, sa isprepletanim prevodom i originalnim tekstom, uz podršku za prevođenje između preko 40 jezika.
- Pažljivo smo razvili tri popularna stila prevođenja: opšti/prirodni (blizak originalu), književni i stručni, koji daju izvanredne rezultate.
- Podržane su i matematičke formule u knjigama.
- Podržava EPUB i PDF formate.
- Podržava i skenirane PDF-ove, koristeći multimodalne funkcije moćnih AI modela. Formule se precizno prepoznaju, a rezultati su odlični čak i za starije knjige.
- Za stručne knjige, korisnici mogu da uploaduju sopstvene glosare sa terminologijom, čime se postiže precizniji prevod u specifičnim oblastima.
- Status prevođenja se automatski čuva lokalno u vašem pregledaču. Ako zatvorite stranicu i ponovo je otvorite, možete nastaviti sa prevođenjem sa mesta gde ste stali. Prevedene knjige se čuvaju u istoriji, pa ih u bilo kom trenutku možete ponovo otvoriti, urediti ili izvesti. (Podržava istoriju prevođenja za poslednjih 10 knjiga)
- Vaši fajlovi se ne uploaduju ni na kakav server; analiza fajlova i zahtevi za prevođenje obavljaju se isključivo u vašem pregledaču.
- Vođeni filozofijom dizajna „komplikovano ostavi softveru, jednostavno korisniku“, interfejs je čist i elegantan, upotreba je intuitivna, a funkcionalnosti su izuzetno moćne, što je do sada rezultiralo brojnim pohvalama.
...
<figure class="post-cover">
  <img src="/uploads/images/ebook-translator/ebook-translator-02.webp" alt="Prikaz prevoda 1" />
</figure>

<figure class="post-cover">
  <img src="/uploads/images/ebook-translator/ebook-translator-04.webp" alt="Prikaz prevoda 2" />
</figure>
...
E-pošta: hi@philoli.com

<figure class="post-cover">
  <img src="/uploads/images/ebook-translator/ebook-translator-01.webp" alt="Kontakt informacije" />
</figure>
...
- [Predstavljam 12 odličnih knjiga: Lista visoko ocenjenih naslova pročitanih 2025. godine](/zh/blog/2025-top-rated-reading-list)
