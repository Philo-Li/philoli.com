...
<div class="formula-pair">
  ...
  <div class="formula-card">
    <p class="formula-card__label">公式 2（镜像版）</p>
...
以上公式一个都不用背，只是加在附录方便大家索引。实际上当你亲自尝试，一遍观察一遍理解对应的方块如何移动，做几次就熟悉了。核心就是交换顶层的三个角块。
...
本教程左右桥的还原步骤：`F'LM2F2U2BUR'U2F'UFR'F'U2MR'URUM'UR'U2RUF'UFU'M'UF'UF`
