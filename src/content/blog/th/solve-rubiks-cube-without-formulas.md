...
(เพิ่มเติม: มีผู้อ่านบางท่านชี้ให้เห็นว่าข้อความข้างต้นไม่ค่อยรัดกุมนัก จึงขอเพิ่มเติมข้อมูลเล็กน้อย จำนวนเต็มภายใต้การบวกเป็นอาเบลเลียนกรุป ในขณะที่จำนวนธรรมชาติ N ภายใต้การบวกไม่ใช่อาเบลเลียนกรุป เช่น 3 ไม่มีตัวผกผัน -3 เนื่องจาก -3 ไม่ใช่จำนวนธรรมชาติ สำหรับจำนวนจริงที่ไม่ใช่ศูนย์, จำนวนตรรกยะที่ไม่ใช่ศูนย์ และจำนวนเชิงซ้อนที่ไม่ใช่ศูนย์ ภายใต้การคูณก็เป็นอาเบลเลียนกรุปเช่นกัน การเปรียบเทียบในบทความต้นฉบับมีจุดประสงค์หลักเพื่อช่วยให้ผู้เริ่มต้นเข้าใจสัญชาตญาณหลักของ "สลับที่ได้ vs สลับที่ไม่ได้" เท่านั้น)
