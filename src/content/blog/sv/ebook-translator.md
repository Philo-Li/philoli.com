...
Här hittar du verktyget: [philoli.com/projects/ebook-translator](https://philoli.com/projects/ebook-translator)

<!--more-->

Verktyget har fått mycket positiv respons sedan det lanserades. Här är de viktigaste funktionerna:

- Översätter valfri bok, med översatt text och originaltext sida vid sida (eller inflätade), och stöder översättning mellan över 40 språk.
- Tre noggrant utvecklade översättningsstilar för vanliga behov: Allmän/naturlig (nära originalet), skönlitteratur och facklitteratur, med utmärkt översättningskvalitet.
- Stöd för matematiska formler i böcker.
- Stöder EPUB och PDF.
- Stöder även skannade PDF-filer. Med hjälp av kraftfulla AI-modellers multimodala funktioner kan formler identifieras korrekt, vilket fungerar utmärkt även för äldre böcker.
- För facklitteratur kan användare ladda upp egna ordlistor för att få ännu mer exakta översättningar inom specifika ämnesområden.
- Översättningsframsteg sparas automatiskt lokalt i din webbläsare. Stänger du sidan och öppnar den igen kan du fortsätta där du slutade. Översatta böcker sparas i historiken och kan när som helst öppnas igen för redigering eller export. (Stöder översättningshistorik för de 10 senaste böckerna).
- Dina filer laddas inte upp till någon server. Filanalys och översättningsförfrågningar hanteras helt i din webbläsare.
- Med designfilosofin "låt programvaran hantera det komplexa, ge användaren det enkla" är gränssnittet rent och elegant, användningen intuitivt enkel, och funktionaliteten tillräckligt kraftfull. Verktyget har redan fått mycket beröm.
...
1.  Öppna [Ebook Translator](https://philoli.com/projects/ebook-translator)
...
<figure class="post-cover">
  <img src="/uploads/images/ebook-translator/ebook-translator-03.webp" alt="Ebook Translator gränssnitt" />
</figure>

## Några exempel på översättningar

<figure class="post-cover">
  <img src="/uploads/images/ebook-translator/ebook-translator-02.webp" alt="Översättningsexempel 1" />
</figure>

<figure class="post-cover">
  <img src="/uploads/images/ebook-translator/ebook-translator-04.webp" alt="Översättningsexempel 2" />
</figure>
...
> Testa själv: [philoli.com/projects/ebook-translator](https://philoli.com/projects/ebook-translator)

## Mer läsning

- [12 bra böcker att dela: Min topplista från 2025](/zh/blog/2025-top-rated-reading-list)
