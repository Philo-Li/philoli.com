...
4.  **Fas 1 – Variabler:**
    Åtgärd: Halvera kolhydratintaget direkt och dokumentera detaljerat det dagliga matintaget.
    Kontroll: Övriga vanor ändras inte i nuläget, men kan justeras stegvis framöver.
5.  **Mätvärden:**
    Objektiva indikatorer: Total sömntid, sömnpoäng (mäts kontinuerligt med sportklocka).
    Subjektiva indikatorer: Mental status efter uppvaknande, energinivå under dagen, sug efter kolhydrater.
...
| Kostregistrering                                                               | Totalt kaloriintag/kcal | Totalt kolhydratintag/g | Sömntid/h | Känsla                                                |
|-------------------------------------------------------------------------------|-------------------------|-------------------------|-----------|-------------------------------------------------------|
| 2025-07-10 Rostad brödskiva, stekt ägg, mjölk, Yakult. Två kokta majskolvar, fyra små ångade bullar | 730                     | 102                     | 5.5h      | Jämfört med vanliga dagar, minskat intag av baslivsmedel med ca 50%. Betydligt längre vakenperiod. |
