...
I hadn't even finished a full pass of the entire Mathematics I textbook. To top it off, that year's Math I exam was unexpectedly the most difficult in recent memory. I wrote down everything I possibly could.
...
Target: 65
Result: Politics - 70 / 100 points.

**English I**

I did the English past paper reading comprehension twice, constantly forgetting core vocabulary after memorizing it. During the exam, I nearly fell asleep while doing the reading section. I had memorized essay templates, but in the exam hall, I let loose and started improvising freely.
Target: 70
Result: English I - 68 / 100 points.

**Specialized Subjects**

For specialized subjects, I hadn't reviewed data structures and algorithms at all, nor two major chapters of computer organization. I'd only gone through the "Wang Dao" (another study guide) once. The 15-point algorithm question on the exam was a complete zero.
Target: Whatever happens, happens.
Result: 408 Specialized Subjects - 106 / 150 points.

Total Score: 334
Interview Cut-off: 361
Applicants for this Major: Approximately 2000
...
**Objective Reasons:**
- Explosion in applicants for Zhejiang University Computer Science
  - Two years ago, there were 1200+ applicants, with an interview cut-off of 330+. Last year, the number surged to 2000 applicants, with a cut-off of 361, and the overall exam difficulty was higher than the previous year.
- Zero-foundation, cross-disciplinary, cross-university, cross-region applicant
  - Commonly known as the "triple-cross" candidate, facing the highest difficulty.

**Subjective Reasons:**
- I'm simply not skilled enough.
- I'm lazy.
- I studied for less than 7 hours a day.
- I only reviewed once and didn't even finish.
...
### Graduate School Isn't That Hard to Get Into
  - Given my extremely poor study habits, my final results weren't terrible, which suggests that the graduate entrance exam isn't overwhelmingly difficult. As long as you're not switching majors to aim for a Top 2 university, most other schools are relatively easy to get into; I've seen plenty of examples among my peers.
  - For those switching majors, as long as it's not a highly competitive field with thousands of applicants, it's generally quite manageable. (Typically, over 500 applicants for a general major is considered a lot.)
  - Even if you're switching to a popular major, as long as you put in a little more effort than I did and don't slack off daily, I don't think it'll be a huge problem.
- And those who successfully get in don't need to constantly brag or act superior.
...
My official preparation for the second attempt still began in July. It was still a relaxed approach, but this time, it was a grounded, relaxed approach.
X words omitted here.
...
> 1. Easier Career Transition
> Pursuing a master's degree could allow me to quickly enter a completely new field.

**Rebuttal:**
- **Transitioning into the computer and internet industry is surprisingly easy.**
  - Some people attend a few months of training and start coding; others, after completing their master's or Ph.D., decide to transition into computer science, self-study relevant knowledge and coding skills for a few months, and then land a job at Google.
  - If the sole purpose is to switch careers, spending three years on a master's degree isn't necessary.

> 2. Academic Advancement
> Having a 985 master's degree is always a good thing, and it can also prove one's capabilities.

**Rebuttal:**
- **I don't have a strong attachment to prestigious universities.**
  - I don't worship authority. In China's exam-oriented education system, many people naturally feel a fondness and reverence for top students. But I believe this is "wolf's milk" that needs to be purged; frankly, it's still a subconscious worship of authority.
  - So why Zhejiang University, specifically? Because its computer science program is top-tier in China, its interview process is famously fair and transparent, and its campus culture promotes freedom and openness.
  - While I don't care what others think, I most wanted to prove my capabilities to my parents, to show them I'm no less capable than anyone else. But there's more than one way to prove yourself.
- **I might not actually enjoy computer-related research.**
  - Computer science research essentially involves reading the latest papers and books, attending lectures, conducting experiments (on a computer), and writing papers.
  - What I do like about computers, however, is that they are a versatile tool, something you can actively operate. You can use them to genuinely accomplish things, even if it's just a tiny piece, but it can change your own life or someone else's.
- **Even if I got in, I wouldn't have free choice of research direction.**
  - Research directions are only finalized after laboratory interviews, and popular labs with sought-after supervisors are always in high demand. It's highly probable I'd end up in a lab not aligned with my interests.
- **Not being a graduate student doesn't stop you from following the latest industry trends.**
  - Unlike other disciplines that require extensive, specialized experimental equipment and strict lab conditions, computer science allows you to do a lot with just an internet-connected computer.
  - No industry boasts more abundant online resources than computer science: an overwhelming amount of learning materials, high-quality open online courses, and countless excellent open-source project codes. You can freely read the latest research papers, and just as easily re-implement the ideas from those papers on your own computer, applying them to your work.
- **Which Carries More Weight: A Master's Degree or Three Years of Work Experience?**
  - Knowledge and technology in the computer industry evolve rapidly. What you learn in graduate school is often not directly applicable in the workplace; everything essentially starts from scratch again.
  - A master's degree + no work experience vs. a bachelor's degree + three years of work experience – in reality, the latter is more competitive in terms of salary.
- **Graduate School is Just Another Box.**
  - Graduate school comes with thesis pressure, deadlines, and the same feeling of constantly being pushed forward.
  - Graduate supervisors are often referred to as "bosses," and just like a job, you're essentially working for your "boss."
  - Having just escaped the confines of university, why rush into another "box" so soon?
  - It's never too late to pursue graduate studies.
...
I just read [an article](https://www.jiqizhixin.com/articles/2018-10-11-4) with a line at the end that resonated deeply with me:
